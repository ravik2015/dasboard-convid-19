    ...
    <View style={styles.dataItem.container}>
      ...
      <View style={styles.dataItem.values}>
        <View
          ...
          <View
            style={[styles.dataItem.valueColor, {backgroundColor: 'orange'}]}
          />
          <Text style={styles.dataItem.valueNum}>
            {numeral(item.cases.total).format('0,0')}
          </Text>
          <Text style={[styles.dataItem.valueNumInfo, {color: 'orange'}]}>
        ...
        <View style={[styles.dataItem.valueContainer, {flexDirection: 'row'}]}>
          <View
            style={[styles.dataItem.valueColor, {backgroundColor: 'red'}]}
          />
          <Text style={styles.dataItem.valueNum}>
            {numeral(item.deaths.total).format('0,0')}
          </Text>
          <Text style={[styles.dataItem.valueNumInfo, {color: 'red'}]}>
        ...
        <View style={styles.dataItem.valueContainer}>
          <View
            style={[styles.dataItem.valueColor, {backgroundColor: 'green'}]}
          />
          <Text style={styles.dataItem.valueNum}>
            {numeral(item.cases.recovered).format('0,0')}
          </Text>
          <Text style={[styles.dataItem.valueNumInfo, {color: 'green'}]}>
